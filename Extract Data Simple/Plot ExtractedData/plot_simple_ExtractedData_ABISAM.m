function plot_simple_ExtractedData_ABISAM(ExtractedData, UserOps)
% Plot output of SAM stim analysis for ExtractedData
...
if ExtractedData.StimInfo.StimProtocol ~= 16
    return;
end
...
disp('Plotting ABI-SAM data')

StimData = simple_subset_ExtractedData(ExtractedData, UserOps);

Ops = StimData.SubsetOps; %StimData.Ops;
...
if isempty(Summary)
    disp('No responsive cells found to plot for ABI-SAM')
    return
end
...
%Return if stim is not a matrix
...
variablesToPlot = {'BestRate', 'BestRate_fit', 'BestRate_fit_halfwidth', 'RSI', 'dprime', 'Sparseness', 'R2'};
responseToPlot = {'BestDepth', 'BestDepth', 'BestDepth', 'BestDepth', 'BestDepth', 'BestDepth', 'BestDepth'}; %For heatmap (All depth rows)
...
variablesToPlot = {'BestDepth', 'BestDepth_fit', 'BestDepth_fit_halfwidth', 'DSI', 'dprime', 'Sparseness', 'R2'};
responseToPlot = {'BestRate', 'BestRate', 'BestRate', 'BestRate', 'BestRate', 'BestRate', 'BestRate'}; %For heatmap (All BF freq column)
...
if Ops.plotCorrelations
    variablesToPlot = {'BestRate', 'BestRate_fit', 'BestRate_fit_halfwidth', 'RSI', 'BestDepth', 'BestDepth_fit', 'BestDepth_fit_halfwidth', 'DSI', 'dprime', 'Sparseness'};
