function plot_simple_ExtractedData_SAM(ExtractedData, UserOps)
...
if Ops.plotCorrelations
    variablesToPlot = {'BestRate', 'BestRate_fit_halfwidth', 'RSI', 'BestDepth', 'BestDepth_fit', 'BestDepth_fit_halfwidth', 'DSI', 'dprime', 'Sparseness'};
