function plot_simple_ExtractedData_ABISAM_APS(ExtractedData, UserOps)
% Plot output of ABI_SAM stim analysis for ExtractedData by activated/prolonged/suppressed
