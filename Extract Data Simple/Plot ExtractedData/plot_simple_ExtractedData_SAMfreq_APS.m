function plot_simple_ExtractedData_SAMfreq_APS(ExtractedData, UserOps)
% Plot output of SAMfreq stim analysis for ExtractedData by activated/prolonged/suppressed
